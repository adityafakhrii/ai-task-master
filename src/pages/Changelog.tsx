...
const changelogData: LogEntry[] = [
    {
        date: '18 Agt 2026',
        version: 'v2.0.0',
        title: 'Redesign Gede-Gedean: Mode Fokus & AI Copilot',
        description: 'Biar lo gak bingung mulai kerjaan bootcamp dari mana! Ada Focus Now auto-rekomendasi AI, 5 menu sat-set (Hari Ini, Inbox, Fokus, Semua Task, Review), Quick Add suara/teks, timer deep work, plus review harian.',
        type: 'feature',
    },
    {
        date: '10 Des 2025',
        version: 'v1.6.0',
        title: 'Auto-Redirect & Final Polish',
        description: 'Kalo udah login ya langsung gaskeun ke dashboard tugas, ngapain liat form login lagi. Sat set wat wet!',
        type: 'fix',
    },
    {
        date: '10 Des 2025',
        version: 'v1.5.0',
        title: 'UI Glow Up & Legal Compliance',
        description: 'Tampilan makin aesthetic pake card rounded, plus halaman privacy policy & terms resmi Google API biar aman sentosa.',
        type: 'feature',
    },
    {
        date: '10 Des 2025',
        version: 'v1.4.0',
        title: 'Overdue Triaging & Modal Nyaman',
        description: 'Task yang telat deadline sekarang bisa langsung ditriage sat-set tanpa drama modal macet.',
        type: 'feature',
    },
    {
        date: '23 Nov 2025',
        version: 'v1.1.0',
        title: 'Otak AI Masuk',
        description: 'Integrasi AI buat parsing tugas cerdas, nyari task semantik, sampe ngingetin prioritas harian lo.',
        type: 'feature',
    },
    {
        date: '20 Nov 2025',
        version: 'v1.0.0',
        title: 'Kelahiran CatetYuk',
        description: 'Awal mula segalanya. Aplikasi catat tugas yang simpel, cepet, dan gak bikin pusing kepala.',
        type: 'feature',
    },
];
